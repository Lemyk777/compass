...
export const COMPETITIONS: Competition[] = [
  ...
  },
  {
    ...
    blurb:
      "Friendly entry-level math contest — a good first competition signal.",
    cost: "varies",
    costDetail:
  ...
  },
  {
    ...
    url: "https://usaco.org/",
    blurb:
      "Promote through Bronze→Silver→Gold→Platinum to prove real CS ability.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Logic-puzzle olympiad bridging languages and CS — no prior knowledge needed.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "The U.S. physics olympiad pipeline — a sharp signal for physics/engineering.",
    cost: "varies",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Neuroscience olympiad — a focused spike for aspiring doctors and researchers.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "The most prestigious U.S. high-school research competition — senior-year capstone.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Team innovation contest — build a real product solving a global problem.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Beginner-friendly app + startup challenge — great first tech project.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "The global economics olympiad — the top international econ credential.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Entry-level entrepreneurship pitch — turn an idea into a venture concept.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    cost: "free",
    costDetail: "Free — teams enter with a teacher advisor and pay nothing.",
  },
  ...
  },
  {
    ...
    blurb:
      "Research-and-present history project — depth in argument and sourcing.",
    cost: "varies",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Written + oral public-policy debate — sharp for law and policy applicants.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Diplomacy, public speaking and current-affairs depth — easy to start.",
    cost: "one_time",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Team academic tournament across subjects — a welcoming first competition.",
    cost: "one_time",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "National honor for emerging artists — the top pre-college arts credential.",
    cost: "one_time",
    costDetail:
  ...
  // ── Summer Programs ────────────────────────────────────────────────────────
  {
    ...
    blurb:
      "The most prestigious and selective STEM summer research program in the world [Fully Funded].",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    url: "https://ssp.org/",
    blurb:
      "Intensive 39-day residential research program in astrophysics, biochemistry, or genomics [Financial aid available].",
    cost: "paid_aid",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Online science and engineering program for rising seniors from underrepresented backgrounds [Fully Funded].",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Highly diverse international summer program covering global challenges, politics, and STEM [Financial aid available].",
    cost: "paid_aid",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Pre-college immersion in China's financial hub, great for business and international relations [Financial aid available].",
  },
  {
    ...
    blurb:
      "Selective summer immersion in China's tech capital, excellent for entrepreneurship and STEM [Financial aid available].",
  },
  // ── Research Programs ────────────────────────────────────────────────────────
  {
    ...
    blurb:
      "Respected, college-credit bearing online research program with university faculty [Financial aid available].",
    cost: "paid_aid",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "The pinnacle free summer seminar for humanities and social sciences — critical, discussion-driven and fully funded [Fully Funded].",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Legendary mathematics summer program for exceptionally talented high schoolers [Financial aid available].",
    cost: "paid_aid",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Premier high school entrepreneurship program — build a real startup [Financial aid available].",
    cost: "paid_aid",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Elite polymer engineering and materials science research program [Some aid/stipends available].",
    cost: "one_time",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Highly selective, fully-funded research program accepting only 12 students globally [Fully Funded/Stipend].",
    cost: "funded",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Intensive mathematics camp at Stanford for advanced high school students [Financial aid available].",
    cost: "paid_aid",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Fully-funded STEM program focused on diversity and rigorous academic preparation [Fully Funded].",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Guided research program ending with a college-level paper [Financial aid available].",
    cost: "paid_aid",
    costDetail:
  ...
  // ── Accessible / Beginner-Friendly Competitions ──────────────────────────────
  {
    ...
    blurb:
      "A fun, beginner-friendly online challenge introducing computational thinking.",
    cost: "varies",
    costDetail:
  ...
  // It is one of the contests that hub lists; its fields moved there.)
  {
    ...
    blurb:
      "Team-based cybersecurity competition perfect for beginners and high schools.",
    cost: "varies",
    costDetail:
  ...
  // don't recommend programs that no longer exist.)
  {
    ...
    blurb:
      "Create an app and submit a video pitch — great entry-level tech portfolio builder.",
    cost: "free",
    costDetail: "Free — no entry fee for students or schools.",
  },
  ...
  // URLs verified 2026-07-29 (npm run test:links).
  {
    ...
    blurb:
      "The world championship of school mathematics — the strongest quantitative signal there is.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "The world final for competitive programming — the top CS credential for an applicant.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "World final in chemistry — a decisive signal for chemistry, medicine and materials.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "World final in biology — the headline credential for pre-med and life sciences.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "World final in astronomy and astrophysics — a rare, highly distinctive spike.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Puzzle-based olympiad bridging languages and computation — no prior linguistics needed.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "The junior science world final — the natural first target for a strong younger student.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Write a philosophical essay in a foreign language — unusual, memorable humanities signal.",
    cost: "free",
    costDetail:
  ...
  // ── Open international competitions (enter directly, no national team) ────
  {
    ...
    blurb:
      "Explain a big scientific idea in a short video — $250k scholarship, judged worldwide.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Environment-focused across science, art, writing and business — unusually broad entry point.",
    cost: "free_then_paid",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Team sustainability challenge with a $200k prize pool — real projects, global field.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Build and program a robot for a themed challenge — strong hands-on engineering evidence.",
    cost: "varies",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Season-long robotics with a real team — the classic sustained engineering commitment.",
    cost: "varies",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Enter directly from any country — a good first international maths credential.",
    cost: "free_then_paid",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Free online team maths contest — low-barrier way to start competing internationally.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "The largest maths prize for young women — a highly recognised selective win.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Water and sustainability research judged internationally — a focused science spike.",
    cost: "free",
    costDetail:
  ...
  // (Diamond Challenge already lives in the Business section above.)
  {
    ...
    blurb:
      "No business plan needed — a short video pitch makes this a genuine first-time entry.",
    cost: "free",
    costDetail: "Free to enter — it is fully online with no entry fee.",
  },
  ...
  // ── Humanities, writing & essay prizes ───────────────────────────────────
  {
    ...
    blurb:
      "Editorial, review, podcast and STEM-writing contests year-round — publishable, low-barrier.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Short subject essay judged internationally, with a programme scholarship attached.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    cost: "free",
    costDetail: "Free — no entry fee for any category.",
  },
  ...
  // (SUMaC and Pioneer Academics already live in the sections above.)
  {
    ...
    blurb:
      "Earn real college credit on campus or online — a credible academic-rigour signal.",
    cost: "paid_aid",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Lifetime support programme for young people who serve others — fully funded, global cohort.",
    cost: "funded",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Mentored independent project on any topic — an accessible way to produce real research.",
    cost: "paid_aid",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Guided research with a PhD mentor, producing an independent paper [need-based aid].",
    cost: "paid_aid",
    costDetail:
  ...
  // Medicine & health  (Brain Bee already lives in the science section above.)
  {
    ...
    blurb:
      "Research-and-solve future scenarios, often health and society — a gentle first entry.",
    cost: "varies",
    costDetail:
  ...
  // Law, politics & debate
  {
    ...
    blurb:
      "Structured debate at every level — the most reliable way to build a law-facing record.",
    cost: "varies",
    costDetail:
  ...
  },
  {
    ...
    url: "https://eyp.org/",
    blurb:
      "Draft and defend resolutions in committee — policy and legal reasoning under scrutiny.",
    cost: "varies",
    costDetail:
  ...
  // Arts & design
  {
    ...
    blurb:
      "Free global photography award with a dedicated youth category — a real published credit.",
    cost: "free",
    costDetail: "Free — the Youth award has no entry fee.",
  },
  {
    id: "toyota-dream-car",
    ...
    blurb:
      "Design the car of the future — one of the few global art contests for younger students.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "The best-known conceptual architecture prize — a standout for design and architecture.",
    cost: "one_time",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Open-ended creative and engineering challenges solved as a team over a season.",
    cost: "varies",
    costDetail:
  ...
  // Business & economics
  {
    ...
    blurb:
      "Run a real student company for a year — the most hands-on business credential available.",
    cost: "varies",
    costDetail:
  ...
  // starting point instead of only olympiad-level entries.
  {
    ...
    blurb:
      "Peer-reviewed journal for school students — turn a class or side project into a citation.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Student-run science journal — publish articles or reviews without needing a lab.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    url: "https://tcr.org/",
    blurb:
      "The only journal publishing serious high-school history essays — a rare humanities credential.",
    cost: "one_time",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Analyse a real dataset and write it up — data skills plus a publication route.",
    cost: "free",
  ...
  },
  {
    ...
    blurb:
      "Publishes student research and essays across every field — a low-barrier first byline.",
    cost: "one_time",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Show any tech project you made — code, hardware or art. No winners' pedigree needed.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Write code that actually runs on the ISS — a real, verifiable first CS credential.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Soccer, rescue and on-stage robot leagues with a genuine route to a world final.",
    cost: "varies",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Long-term creative engineering problems solved as a team — starts as young as primary school.",
    cost: "varies",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "The classic problem-solving olympiad across the CIS — a junior paper exists from year one.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    url: "https://izho.kz/",
    blurb:
      "Maths, physics and informatics olympiad hosted in Almaty — the nearest elite stage there is.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "The largest MUN conference, at the UN itself — a serious first law-and-policy credential.",
    cost: "one_time",
    costDetail:
  ...
  // ends up recommended twice.)
  {
    ...
    blurb:
      "A world-famous photography award with a category for ten-year-olds. One image is the entry.",
    cost: "free",
  ...
  },
  {
    ...
    url: "https://icaf.org/",
    blurb:
      "The world's largest art program for children — the rare entry aimed below secondary school.",
    cost: "free",
    costDetail: "Free — schools and students enter at no cost.",
  },
  ...
  // Verified 2026-08-01.
  {
    ...
    blurb:
      "Simulate a government under Harvard-run committees — legislation, debate and negotiation.",
    cost: "one_time",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Model UN run by the UN's own association, using real UN rules of procedure.",
    cost: "one_time",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Student-run neuroscience clubs, contests and publishing — the softest landing into medicine.",
    cost: "free",
    costDetail:
  ...
  // Deliberately the NICHE variants, not the banal intro everyone lists.
  {
    ...
    blurb:
      "Search, knowledge, optimization, neural nets — Harvard's AI course, free and self-paced.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "How systems get attacked and defended, for a general audience — a rare beginner cyber course that carries a name.",
    cost: "free",
    costDetail:
      "Free to take, and CS50 issues its own free certificate from cs50.harvard.edu. The paid one is the OPTIONAL edX verified certificate, and it is not cheap — roughly $200-300 depending on the course (Harvard lists $219 for CS50 Python). You never need it: the course, the problem sets and the free CS50 certificate cost nothing.",
  },
  {
    ...
    blurb:
      "MIT's flagship intro to deep learning — lectures, code labs and guest talks, all free online.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "A Nobel laureate's tour of risk, insurance and markets — the serious econ course to name before university.",
    cost: "free_cert_paid",
    costDetail:
  ...
  // ── Internships / open-source (real, paid, remote, global) ─────────────────
  {
    ...
    blurb:
      "Get paid to write open-source software with a real project and mentor — remote, from anywhere.",
    cost: "funded",
    costDetail:
  ...
  },
  {
    ...
    tier: "accessible",
    eligibility:
      "Middle- and high-school students worldwide — free; all levels",
    url: "https://picoctf.org/",
    blurb:
      "Learn hacking by doing it — Carnegie Mellon's free capture-the-flag, from first puzzle to hard.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Real data-science problems with public leaderboards — the standard way to prove ML skill from anywhere.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "The global home of competitive programming — free rounds several times a week, a rating you can grow.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "A worldwide network of teenage makers — start a club, join a hackathon, ship real projects.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "An Olympics of robotics with one team per nation — built so students everywhere, not just rich schools, compete.",
    cost: "varies",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Design a tiny experiment that actually flies to near-space on a NASA rocket or balloon — free, for young students.",
    cost: "free",
    costDetail:
  ...
  // ── Immersive summer maths (competitive, but with real financial aid) ──────
  {
    ...
    blurb:
      "Deep number theory from scratch, the way mathematicians actually think — famously transformative, with aid.",
    cost: "paid_aid",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Five weeks of mathematics you choose yourself, with real mathematicians — need-blind aid for internationals.",
    cost: "paid_aid",
    costDetail:
  ...
  // ── More free university courses (highest-accessibility type) ──────────────
  {
    ...
    blurb:
      "Build and deploy real web apps (Django, React, SQL) — the practical follow-on to CS50.",
    cost: "free",
    costDetail:
      "Free to take, and CS50 issues its own free certificate from cs50.harvard.edu. The paid one is the OPTIONAL edX verified certificate, and it is not cheap — roughly $200-300 depending on the course (Harvard lists $219 for CS50 Python). You never need it: the course, the problem sets and the free CS50 certificate cost nothing.",
  },
  ...
  },
  {
    ...
    blurb:
      "The web-dev course companies actually rate — React, Node, GraphQL, testing — free from a real university.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "What AI actually is, for everyone — a famous free course that a whole country used to reskill.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    tier: "accessible",
    eligibility:
      "Anyone worldwide — free to audit; the classic first ML course",
    alwaysOpen: true,
    url: "https://www.coursera.org/specializations/machine-learning-introduction",
    blurb:
      "The machine-learning course that taught a generation — rebuilt and still free to audit.",
    cost: "free_cert_paid",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "The shell, git, editors, debugging — the practical skills that make everything else faster. Free from MIT.",
    cost: "free",
    costDetail:
  ...
  // ── Do-it-anywhere CS contests & fellowships ───────────────────────────────
  {
    ...
    blurb:
      "A daily December programming puzzle with a huge global following — the friendliest way into coding contests.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    deadline: "2027-06-30",
    window:
      "Self-paced — hundreds of problems, solve any time, no registration",
    level: "international",
    category: "competition",
    tier: "accessible",
    ...
    blurb:
      "Maths problems you crack with code — an endless, free ladder that builds real problem-solving.",
    cost: "free",
    costDetail: "Free — an account is all you need, and there is no paid tier.",
  },
  {
    id: "atcoder",
    ...
    blurb:
      "Japan's top competitive-programming judge, in English — clean problems and a rating you can climb.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Twelve weeks building real open-source or projects with a mentor and a pod — fully remote, from anywhere.",
    cost: "funded",
    costDetail:
  ...
  // ── Physics, engineering, maths modelling (teams, global) ──────────────────
  {
    ...
    blurb:
      "Argue open-ended physics problems like real researchers — a debate-tournament, not an exam.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "A team takes a messy real-world problem and models it over a few days — maths that looks like the job.",
    cost: "varies",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Get placed on a global team to solve a real STEM challenge online, mentored — free, and selective on merit not money.",
    cost: "free",
    costDetail:
  ...
  // ── Writing, economics, the humanities (global, low-cost) ──────────────────
  {
    ...
    blurb:
      "A respected literary prize that reads student work seriously — poetry or prose, judged by real writers.",
    cost: "one_time",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "One of the biggest youth poetry awards anywhere — free, open worldwide, and it has launched real careers.",
    cost: "free",
    costDetail:
  ...
  // ── Free courses across fields (not just CS) — the accessible core ─────────
  {
    ...
    blurb:
      "The most popular course Harvard ever put online — how to reason about right and wrong, for free.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "A free, project-based route into web development that people actually get hired from — no fee, ever.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "The most-taken online course in the world — how your brain learns, and how to study far less painfully.",
    cost: "free_cert_paid",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "A toolbox of models for thinking clearly about the world — economics, networks, decisions — free.",
    cost: "free_cert_paid",
    costDetail:
  ...
  },
  {
    ...
    url: "https://mru.org/",
    blurb:
      "Economics explained in short, sharp videos by real economists — the friendliest serious econ on the web.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "A recognised, career-ready data credential you can earn from anywhere — spreadsheets, SQL, R, dashboards.",
    cost: "free_cert_paid",
    costDetail:
  ...
  },
  {
    ...
    deadline: "2027-06-30",
    window:
      "Self-paced online (MIT OpenCourseWare) — videos and problems, free",
    level: "international",
    category: "course",
    tier: "accessible",
    eligibility:
    ...
    blurb:
      "The legendary linear-algebra course — the foundation under ML, engineering and computer graphics, free from MIT.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "MIT's first-year physics — the real thing, with problem sets and exams, free to work through at your pace.",
    cost: "free",
    costDetail:
      "Free forever — MIT OpenCourseWare publishes the whole course (videos, problem sets, exams) with no account and no fee. There is no certificate at all, paid or free.",
  },
  ...
  },
  {
    ...
    blurb:
      "A proper university genetics course, free to audit — the serious biology foundation before medicine.",
    cost: "free_cert_paid",
    costDetail:
      "Free to audit: lectures and readings cost nothing. The certificate is paid (roughly $49-79, or included in a Coursera Plus subscription), with Coursera financial aid available on the course page — it covers most of the fee if granted, not always all of it.",
  },
  ...
  // ── Data-science contests built for emerging markets, and remote research ──
  {
    ...
    blurb:
      "A data-science community that grew up outside Silicon Valley — real competitions, open to everyone, no gatekeeping.",
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Data-science competitions where the prize is impact — health, conservation and public services, not just a leaderboard.",
    cost: "free",
  ...
  },
  {
    ...
    blurb:
      "A real, recognised Git & GitHub certification — free to sit if you verify as a student, from age 13.",
    alwaysOpen: true,
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Thousands of hours of coding, free, with certifications people list on real CVs — no age limit, no fee.",
    alwaysOpen: true,
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Cisco's free, phone-friendly courses with entry-level certificates — cybersecurity and Python from age 13.",
    alwaysOpen: true,
    cost: "free",
    costDetail:
  ...
  },
  {
    ...
    blurb:
      "Learn to code entirely on your phone — bite-size, free, 20+ languages. Built for exactly no-laptop situations.",
    alwaysOpen: true,
    cost: "freemium",
    costDetail:
  ...
  },
  {
    ...
    cost: "freemium",
    costDetail:
      "The community, the wiki and the problem archives are free with a free account. AoPS also sells structured online courses, and those are not — you never need them to use the forums.",
  },
  {
  ...
  },
  {
    ...
    cost: "free",
    costDetail:
      "Free — a joint initiative of the California Academy of Sciences and National Geographic. No paid tier.",
  },
  {
    id: "scistarter",
    name: "SciStarter",
    ...
    cost: "free",
    costDetail:
      "The directory is free. Individual projects occasionally need a kit you buy, and each project page states that — check before committing.",
  },
  {
    id: "intaward",
  ...
  },
  {
    ...
    cost: "free",
    costDetail:
      "There is no fee to Rotary for Interact membership. Individual clubs sometimes collect small dues for their own projects — ask the sponsoring club.",
  },
  {
    ...
    cost: "free",
    costDetail:
      "Free — the curriculum, the materials and the facilitator training are all provided at no cost.",
  },
  {
    id: "hacktoberfest",
    name: "Hacktoberfest",
    ...
    cost: "free",
    costDetail:
      "Free to take part. Rewards have varied between years — treat the contribution as the point and anything else as a bonus.",
  },
  {
    id: "foldit",
    name: "Foldit",
    ...
    cost: "free",
    costDetail:
      "Free — a research project run out of the University of Washington. Nothing is sold.",
  },
  {
