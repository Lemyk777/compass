...
export const HOME_ROUTES: HomeRoute[] = [
  {
    ...
    proof:
      "A public commit history with your name on it, in a project strangers use. That's the strongest single artefact on this whole list. It is verifiable, permanent, and it shows how you work rather than claiming it.",
    whoThrives:
      "Suits you if you can work alone against a vague problem and ask good questions in public. Look elsewhere if you need someone to tell you what to do next. Mentors here guide, they don't supervise.",
  },
  {
    id: "data-competitions",
    name: "Data-science competitions",
    fields: ["computer_science", "natural_sciences", "business_economics"],
    what: "Kaggle and Zindi run open machine-learning contests judged purely on a score against held-out data. Nobody sees your school, your country or your age, only the number. They're also the cheapest teacher available: Kaggle publishes free short courses, and every finished competition leaves behind the winners' own notebooks explaining exactly what they did and why, which is a level of access no textbook gives you.",
    catch:
      "The leaderboard is honest but brutal, and the top of it is professionals. Treat the first several attempts as learning rather than as a result you'll put on an application. The failure mode is the opposite of laziness: people spend months 'preparing' before entering, and preparation without a submission teaches almost nothing.",
    firstMove:
      "Enter one beginner-tier competition and submit something bad on purpose, just to get through the whole loop once. The second submission is where learning starts. Then read the discussion thread and one public notebook from someone above you, and copy their approach deliberately. That isn't cheating, it is how the field teaches itself.",
    commitment:
    ...
    proof:
      "A public profile with a ranking and, more usefully, the notebooks showing your reasoning. A modest placing you can explain beats a better one you can't.",
    whoThrives:
      "Suits you if you like being scored objectively and aren't discouraged by a leaderboard full of professionals. Look elsewhere if you need collaboration. This is mostly solitary work.",
  },
  {
    ...
    what: "Journals for school-age researchers, essay competitions run by universities, and open science projects accept work from anywhere and judge the work itself.",
      ...
      "A serious piece takes months and usually needs an adult who knows the field to read a draft, and a teacher is enough. Beware anything that charges a large fee to publish you; being printed isn't the same as being reviewed.",
    firstMove:
    ...
    proof:
      "A finished, dated piece of work with your argument in it: published, entered somewhere, or simply readable. Length isn't the point; a tight ten pages that answers one question properly is the artefact.",
    whoThrives:
  ...
  },
  {
    ...
    commitment:
      "Several hours a week for the length of the course, and the completion rate on open courses is famously low precisely because nothing external holds you to it. Treat the schedule as real or it won't happen.",
    proof:
  ...
  },
  {
    ...
    what: "Design, software and writing are bought remotely, which means the pay for a piece of work stops being set by the town you live in.",
      ...
      "Getting the first client is the hard part and referrals dominate; payment, tax and contracts are your problem, and rates start low until you've something public to point at. This is a route for older students, not for a 14-year-old.",
    firstMove:
    ...
    proof:
      "Paid work for someone who isn't related to you, and pieces you are allowed to show. The first paying client is the credential. Everything after it is easier.",
    whoThrives:
  ...
  },
  {
    ...
    firstMove:
      "Find the teacher who will give you a room and an hour a week, and run the first session for whoever turns up, even if it is only two people.",
    commitment:
    ...
    proof:
      "A thing that exists and outlasts you: members, sessions run, a result someone else can confirm. It's the most locally verifiable item on this list, and the hardest to fake.",
    whoThrives:
