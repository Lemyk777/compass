...
export const HUBS: Hub[] = [
  ...
  },
  {
    ...
    money:
      "Costs are lower than Warsaw's on every line — rent, food, transport — while tuition in English-taught programmes at public universities stays moderate and scholarships exist for strong applicants. Technology salaries are respectable by Polish standards and below Western European ones, which is the trade the whole city represents. The EU degree is the asset you are actually buying.",
    language:
      "The technology and services offices work in English and English-taught degrees are easy to find, but Kraków is less international than Warsaw, so Polish opens far more of the city, the part-time work and the friendships. It is a shorter climb from Russian than German is.",
    whoThrives:
      "Suits you if you want an EU degree in a student city rather than a business capital, close to home and at a manageable cost. Look elsewhere if you want the country's largest job market — that is Warsaw — or a deep research ecosystem.",
  },
  {
    id: "milan",
    city: "Milan",
  ...
  },
  {
    ...
    route: "Public tuition scales to family income and the regional DSU scholarship can cover fees and a living grant — the same mechanism that makes Italy the cheapest realistic route into Western Europe.",
    dayHere:
    ...
    whoThrives:
      "Suits you if you want humanities, medicine or law in Europe at a cost the Italian system makes possible, and you will learn Italian. Look elsewhere if you want a fast technical career start — Milan is the working city — or you cannot tolerate slow administration.",
  },
  {
    id: "zurich",
    city: "Zurich",
  ...
  // ── Middle East & Türkiye ─────────────────────────────────────────────────
  {
    ...
    money:
      "International tuition is the same order as the rest of the UK — high, and the real cost of the decision — but living costs are among the lowest of any big British city, which changes the total more than students expect. Scholarships exist and are competitive rather than need-based. Work during term is capped by the hours limit on the student visa, so it supplements a budget and cannot build one.",
    language:
  ...
  // ── Asia-Pacific ──────────────────────────────────────────────────────────
  {
    ...
    whoThrives:
      "Suits you if you want a funded, English-taught technical degree close to home in a language family you already half know. Look elsewhere if you want a large private job market — Istanbul has it and Ankara does not — or a stable currency to plan against.",
  },
  {
    id: "seoul",
    city: "Seoul",
  ...
  },
  {
    ...
    catch: "Small, quiet and built around laboratories rather than city life — and Korean is needed for almost everything outside the campus.",
    ...
    language:
      "Research groups publish and often work in English, and the government scholarship includes a year of Korean before the degree starts. Everything outside the laboratory — housing, healthcare, part-time work, the social side — runs in Korean, and staying on to work here makes it non-negotiable.",
    whoThrives:
  ...
  },
  {
    ...
    whoThrives:
      "Suits you if you want a funded degree inside a major research system and see China as a direction rather than a detour. Look elsewhere if your work needs an open internet, or if you cannot commit to Mandarin.",
  },
  {
    id: "shanghai",
    city: "Shanghai",
    ...
    language:
      "The most navigable Chinese city in English — degrees, offices and services accommodate it — but Mandarin still decides how far you get with an employer, a landlord or a lease. The joint programmes with foreign universities teach in English throughout, which is why they are the usual first step.",
    whoThrives:
  ...
  },
  {
    ...
    dayHere:
      "Green, wet and dark for a long stretch of winter, wrapped in mountains and water that make the summers exceptional. It is socially quieter than the East Coast and the reputation for being hard to make friends in is earned. The city is still built for cars despite improving transit, and rents are high without being San Francisco's.",
    money:
  ...
  },
  {
    ...
    what: "Canada's Pacific technology and film centre, close enough to Seattle that American companies staff engineering offices here when they cannot get visas.",
    ...
    route: "A study permit allows work during term, and the post-graduation work permit gives you time to convert a degree into experience — the clearest study-to-residence ladder in this guide.",
    dayHere:
      "Mild, rainy and green, with mountains and ocean inside the city limits and outdoor life built into the week. It is the most physically beautiful place on this map and the hardest to afford, and both facts shape every decision people make here. Transit is good, the city is small enough to cross, and the long-established Asian communities make arriving from abroad easier than most places.",
    money:
    ...
    whoThrives:
      "Suits you if the goal is a technology or engineering career in North America with a defined route to staying, and you can absorb the housing cost. Look elsewhere if your budget is tight — Montreal costs a fraction — or if you want the deepest job market, which is Toronto's.",
  },
  {
    id: "montreal",
    city: "Montreal",
    ...
    whoThrives:
      "Suits you if you want North America at the lowest cost and will learn French to stay. Look elsewhere if you need an English-only path to permanent residence, or the largest corporate job market — that is Toronto.",
  },
];
