  ...
  engineering: [
    {
      ...
      dayToDay:
        "Most of the week is CAD models, tolerance and load calculations, and arguing with a supplier about why the part that arrived isn't the part you drew. Then a prototype fails on the bench and you spend two days finding out whether it was the design, the material or the way it was assembled. Engineers here live between a screen and a workshop, and the people who enjoy it are the ones who like the workshop half.",
      catch:
      ...
      tryItNow:
        "Model something real in free CAD: a part from a broken appliance, measured with calipers. Then try to make it printable or machinable. The gap between the drawing and the thing that actually fits is exactly what this job is.",
    ...
    },
    {
      ...
      notForYou:
        "You expect to move country freely with your qualification. This one is bound to a national rulebook and a licence, so relocating usually means re-qualifying. And if mud, site visits and early mornings aren't for you, the desk half of this field is smaller than it looks from outside.",
      misconception:
        "That it is about designing landmark bridges. Almost all of it is ordinary buildings, roads, drainage and water: the invisible infrastructure a country runs on. The skill being paid for is judgement about safety and cost, not visual imagination.",
      stages: {
        school:
      ...
      tryItNow:
        "Build the strongest bridge you can from spaghetti or paper, load it until it breaks, then work out from the wreckage which member failed and why. That loop, predict then test then explain the failure, is the whole discipline in miniature.",
    ...
    },
    {
      ...
      notForYou:
        "Your passport won't clear the security requirements where you want to work. Check that before you choose a degree, not after: a great many aerospace and defence roles require citizenship or a clearance in the country of the work, and no amount of ability opens them.",
      misconception:
        "That the industry is astronauts and launches. It's overwhelmingly analysis, certification and incremental improvement of aircraft and satellites. The large majority of aerospace employment is aviation, not space.",
      stages: {
        school:
        ...
        study:
          "Aerospace, or mechanical with an aerospace specialisation: aerodynamics, propulsion, structures, control and a lot of simulation. Check the citizenship rules of the countries you might work in BEFORE choosing where to study; it is the one constraint here that ability can't overcome.",
        first:
          "A junior analyst or test engineer inside one narrow subsystem, working to a standard you didn't write. The field rewards patience: seniority here is measured in programmes seen through, and those take years each.",
      },
      tryItNow:
  ...
  computer_science: [
    {
      ...
      stages: {
        ...
        study:
          "A CS degree gives you the durable half: algorithms, systems, networks, how a computer actually works. Which is the part that doesn't go stale. Self-teaching genuinely works in this field, but it puts the burden of that foundation on you, and visa routes to work abroad usually assume a degree.",
        first:
      ...
      tryItNow:
        "Build one small thing you'll actually use, put it online, and give the link to someone. The distance between 'it works on my machine' and 'a stranger used it' is where the profession lives.",
    ...
    },
    {
      ...
      dayToDay:
        "Most of the week isn't modelling. It's finding the data, discovering it is inconsistent, deciding what a row actually means, and building the pipeline that keeps it arriving. Then a model, then the harder part: convincing a colleague who doesn't trust statistics that the number is real, and finding out whether it changed any decision at all.",
      catch:
      ...
      stages: {
        ...
        first:
          "Usually analyst before scientist: dashboards, reports, and answering other people's questions. That isn't a detour. It is how you learn what the organisation's data actually represents, without which no model of it is trustworthy.",
      },
      tryItNow:
    ...
    },
    {
      ...
      dayToDay:
        "Building systems and then tuning them by feel: an enemy isn't 'done' when it works, but when it feels right, which is decided by playing the same thirty seconds a hundred times. Days are engine work, performance budgets, tooling for the artists and designers, and a great deal of iteration on things players will never consciously notice.",
      catch:
      ...
      stages: {
        school:
          "Make small finished games. A jam game completed in a weekend is worth more than an ambitious project abandoned at 30%, because finishing is the skill studios can't teach you.",
        study:
  ...
  business_economics: [
    {
      ...
      notForYou:
        "You need a predictable salary, or you are waiting for the right idea to arrive. Most new businesses run out of money slowly while the founder works harder than everyone around them. Joining a small company early teaches the same lessons on someone else's money.",
      misconception:
      ...
      stages: {
        school:
          "Sell something small and real: repairs, tutoring, a service for local businesses. Keep the accounts honestly. Earning the first money from a stranger teaches more than any competition.",
        study:
          "Any degree, or none. What a business or economics degree gives you is the shared language of finance and the network; what it can't give you is customers. Many strong founders study something else entirely and start on the side.",
        first:
    ...
    },
    {
      ...
      dayToDay:
        ...
        "The hours in the entry-level investment roles are genuinely punishing. Long nights and weekends are the normal expectation, not the exception, and that is the trade being made for the pay. It's also cyclical: this is one of the first sectors to cut staff in a downturn, and much of the routine analytical work is being automated.",
      suitsYou:
        "You are disciplined rather than bold, you like defending an assumption in detail, and the long entry-level hours are a trade you are making with your eyes open rather than one you'll find out about in your first month.",
      notForYou:
    ...
    },
    {
      ...
      dayToDay:
        ...
        "Travel and hours, and a peculiar kind of distance: you recommend, others decide, and you often leave before finding out whether it worked. It's also famously an 'up or out' career structure in the large firms, which is bracing rather than secure, and the constant novelty means you rarely become deeply expert in anything.",
      suitsYou:
      ...
      misconception:
        "That consultants are hired because they know the answer. They're usually hired for capacity, an outside view, or political cover for a decision already half-made. Understanding that is what separates people who are effective in the job from people who are frustrated by it.",
      stages: {
        school:
    ...
    },
    {
      ...
      dayToDay:
        ...
        "You are measured constantly and publicly, and the numbers are often outside your control. A market shifts, a platform changes its rules overnight, and the results move without you doing anything wrong. It's also the function that gets cut first when a company tightens, and the channels you specialise in keep being replaced.",
      suitsYou:
      ...
      notForYou:
        "You want your results to reflect your effort. A platform changes its rules overnight and the numbers move without you having done anything wrong. This is also usually the first function cut when a company tightens, which is a structural fact rather than bad luck.",
      misconception:
      ...
      stages: {
        school:
          "Run something real with an audience: a page, a small shop, an event, a school campaign. Pay attention to what made the numbers move. That record is the portfolio.",
        study:
        ...
        first:
          "Executing rather than deciding: scheduling, copy, reports, campaign admin. The judgement about strategy arrives once you've watched enough campaigns succeed and fail to have an instinct worth paying for.",
      },
      tryItNow:
        "Take something you want people to do, whether that is attend, buy or sign up. Write two different messages for it, show each to a different group, and count. That's the whole discipline compressed into a week.",
  ...
  natural_sciences: [
    {
      ...
      dayToDay:
        "Long stretches of careful repetition punctuated by rare, genuine surprise. You plan an experiment, run it, find the equipment or the sample was the problem, run it again, and record everything. The other half of the job is writing: papers, grant applications, reviews. In research, work that isn't written up and funded doesn't continue.",
      catch:
      ...
      suitsYou:
        "You find it satisfying to establish carefully that something isn't the case, you write well and often, and you can accept several years of fixed-term contracts, frequently in a different country each time, before knowing whether a permanent post exists for you.",
      notForYou:
      ...
      misconception:
        "That it is about discovery. It's mostly about elimination: establishing carefully that something isn't the case. A successful career is built from many small, solid, unexciting results rather than one breakthrough.",
      stages: {
        school:
    ...
    },
    {
      ...
      suitsYou:
        "You can be scrupulously neutral about what your data does and doesn't show, including when the answer is inconvenient, and you are willing to do the measuring and the reporting that is what makes you trusted.",
      notForYou:
      ...
      misconception:
        "That it is activism with a degree. Professionally it is measurement and evidence, and being trusted depends on being scrupulously neutral about what your data does and doesn't show, including when the answer is inconvenient.",
      stages: {
        school:
          "Chemistry, biology, geography and statistics. Join any real monitoring or restoration project locally; the ability to say you've collected field data properly is worth more than enthusiasm.",
        study:
      ...
      tryItNow:
        "Measure something in your own area over several weeks: air quality, water, plant or bird counts, with a consistent method, and write up what you found and what you can't conclude. That last part is the science.",
    ...
    },
    {
      ...
      dayToDay:
        "Programming and statistics, far more than telescopes. Modern astronomy is largely computational: you work with archived survey data, write code to process it, and spend weeks establishing that a signal isn't an artefact of your instrument or your method. Observing time is scarce, competitive, and increasingly done remotely rather than at an eyepiece.",
      catch:
      ...
      notForYou:
        "You want this specific field or nothing. Permanent positions are few relative to the number of people trained, the route to one runs through several fixed-term posts in different countries, and most graduates build their careers elsewhere. That is a good outcome, but not the pictured one.",
      misconception:
      ...
      stages: {
        ...
        first:
          "A PhD position, then postdoctoral work abroad. Alongside that, be aware that the skills transfer directly: large-scale data analysis, simulation, statistics. They go directly into data and quantitative work, and many people move that way by choice.",
      },
      tryItNow:
    ...
    },
    {
      ...
      dayToDay:
        "Bench work inside a process. You run assays, formulate or test materials, and document every step to a standard that an inspector could audit years later. In regulated industries such as pharmaceuticals, food and forensics, the documentation isn't overhead, it is the product: work that isn't recorded correctly didn't happen.",
      catch:
      ...
      misconception:
        "That industry science is a lesser version of academic science. It's a different job: the question is set by a product and a deadline rather than by curiosity, and the reward is that things you work on actually reach people, with the trade that you rarely choose the question.",
      stages: {
        school:
      ...
      tryItNow:
        "Run any careful, repeatable experiment at home: fermentation, crystal growth, a titration with kitchen chemicals Keep a proper lab notebook with dates, quantities and deviations. Whether that record-keeping bores or satisfies you is genuinely diagnostic.",
  ...
  humanities_social: [
    {
      ...
      dayToDay:
        ...
        "The clinical routes are long and licensed: in most countries an undergraduate psychology degree alone doesn't let you practise, and the postgraduate places are few and highly competitive. The work itself carries the weight of other people's distress, which is real and cumulative. Burnout and vicarious trauma are occupational hazards the profession takes seriously.",
      suitsYou:
      ...
      notForYou:
        "You want to be practising soon, or you want to help people without the statistics. In most countries an undergraduate psychology degree alone doesn't license you, the postgraduate places are few and highly competitive, and research methods sit at the centre of the training.",
      misconception:
        "That psychology is mostly about understanding people intuitively. It's an empirical science with statistics at its centre, and a large part of training is learning why intuition about behaviour is unreliable and how to test it instead.",
      stages: {
        school:
    ...
    },
    {
      ...
      values: ["creating", "freedom"],
      dayToDay:
        "Reporting is mostly contact and verification: calling people who don't want to talk to you, checking a claim against a document, and then writing fast to a length and a deadline. Editing is shaping other people's work and killing your own favourite sentences. Content and communications roles are steadier and more planned, but the underlying skill is identical: finding out what is true and saying it clearly.",
      catch:
        "The economics are hard and have been for two decades: staff jobs are fewer, freelance rates are low and payment is slow, and much of the entry-level work is unstable. In many countries journalism also carries real personal risk, whether legal, political or physical, and that is worth weighing honestly rather than romantically.",
      suitsYou:
        "You would rather find out what is true than write beautifully about it, you are willing to keep calling people who don't want to talk to you, and you can build a reputation piece by piece rather than through one opportunity.",
      notForYou:
    ...
    },
    {
      ...
      suitsYou:
        "You are good at drafting and compromise, you can find the version of a position that enough parties will live with, and you don't need the good outcome to be attributable to you when it finally arrives.",
      notForYou:
      ...
      stages: {
        school:
          "Model UN and debate genuinely mirror the work. Learn a second language properly; in this field it isn't a nice extra, it is often the qualification.",
        study:
    ...
    },
    {
      ...
      suitsYou:
        "You like diagnosing why one particular person hasn't understood, and you are steady enough to manage thirty different states of attention at once, or patient enough for long solitary drafting and the seminars that test it.",
      notForYou:
      ...
      misconception:
        "That teaching is explaining things you know. Most of the craft is diagnosing why a particular student hasn't understood, and managing thirty different states of attention at once. Subject knowledge is the entry ticket, not the skill.",
      stages: {
        school:
        ...
        first:
          "Trainee teacher with a mentor and a reduced timetable, or doctoral researcher with teaching duties attached. Both first years are exhausting in the same specific way: you are learning to do publicly something you've only done privately.",
      },
      tryItNow:
        "Teach one 20-minute lesson on something you know to people who don't, and ask them afterwards what they actually took away. The gap between what you said and what landed is the entire profession.",
  ...
  medicine_health: [
    {
      ...
      dayToDay:
        "Pattern recognition under time pressure, then documentation. You see many patients in sequence, most with ordinary problems, and the skill is noticing the one presentation that doesn't fit. A very large share of the day is notes, referrals and handovers. The record is a legal document, and writing it well is part of the clinical job, not separate from it.",
      catch:
        "It's the longest training route on this list: a decade or more from starting university to independent practice in many specialties, with shift work, nights and weekends throughout, and emotional weight that doesn't stay at work. International students should also check licensing early: medical qualifications transfer between countries poorly, and practising elsewhere often means further examinations and supervised years.",
      suitsYou:
        "You can decide under uncertainty, tell people things they don't want to hear, and still care attentively at the end of a long shift. A decade of training with examinations continuing past graduation is a price you've looked at clearly rather than assumed away.",
      notForYou:
        "You intend to work in a country other than the one you qualify in and haven't checked what that takes. Medical qualifications transfer poorly, and practising elsewhere usually means further examinations and supervised years. Verify that ladder before you commit ten of them.",
      misconception:
        "That the hard part is knowing enough. The hard parts are deciding under uncertainty with incomplete information, telling people things they don't want to hear, and continuing to care attentively at the end of a long shift.",
      stages: {
        school:
          "Biology and chemistry, at the level your target countries require. Entry rules differ sharply, and some admit school-leavers directly while others require a prior degree. Get real clinical exposure: volunteering, care work, shadowing. It's both expected in applications and the honest test of whether you can be near illness daily.",
        study:
          "Medical or nursing school: several years of pre-clinical science, then clinical rotations where you learn on real wards. It's demanding continuously rather than in bursts, and the examinations continue well past graduation.",
        first:
    ...
    },
    {
      ...
      misconception:
        "That it is medicine at a larger scale. It's closer to statistics, economics and communication applied to health. You'll spend more time with datasets and stakeholders than with patients, and many of the strongest people in it never trained clinically at all.",
      stages: {
        school:
    ...
    },
    {
      ...
      notForYou:
        "You want your work in front of people within a few years, or you aren't genuinely comfortable with animal research where your area requires it. Laboratory to patient typically takes over a decade, and the overwhelming majority of candidates fail somewhere along the way.",
      misconception:
      ...
      stages: {
        ...
        first:
          "Research assistant or doctoral researcher on one small piece of a larger question. Industry alternatives such as trials coordination, regulatory affairs and medical science liaison are well-paid, stable and often overlooked by students who assume academia is the only destination.",
      },
      tryItNow:
    ...
    },
    {
      ...
      dayToDay:
        ...
        "Regulation slows everything: a change that would take a week in ordinary software can take months of validation and paperwork, and that pace frustrates people who came from tech. Clinical data is also heavily restricted for good reasons, so you often can't look at the thing you need, and mistakes here have consequences no amount of iteration undoes.",
      suitsYou:
        "You hold both halves, the biology and the code, and you can accept a regulator watching every design decision, because mistakes here aren't the kind that iterating undoes.",
      notForYou:
  ...
  law: [
    {
      ...
      dayToDay:
        "Reading and drafting, mostly. Documents, precedent, correspondence, and the slow assembly of a case from evidence. Courtroom advocacy is a small fraction of the time even for litigators, because most disputes settle. A large part of the job is managing clients who are frightened, angry or unrealistic about what the law can do for them.",
      catch:
        "Law is the least portable qualification on this list: it is national, so a degree earned in one country frequently doesn't let you practise in another without substantial requalification. Billable-hour culture in commercial practice means long, closely measured days, and the profession reports high rates of stress and burnout. That is worth knowing before, not after.",
      suitsYou:
      ...
      misconception:
        "That it is about argument and advocacy. It's about preparation: the person who has read every document and anticipated the other side's best point wins, and courtroom performance mostly reflects work done weeks earlier.",
      stages: {
        school:
    ...
    },
    {
      ...
      misconception:
        "That it is a career of dramatic victories. Most of it is procedural persistence: filing correctly, meeting deadlines, exhausting remedies. The wins that matter usually arrive years after the work that caused them.",
      stages: {
        school:
    ...
    },
    {
      ...
      misconception:
        "That commercial law is dry compared with courtroom work. It's where a great deal of the actual power sits: the contract, the patent and the data policy shape what companies can do long before any dispute exists.",
      stages: {
        school:
  ...
  arts_design: [
    {
      ...
      notForYou:
        "You want your ideas to survive intact. Work here is edited by committee and diluted by people with more authority than taste. 'Design' is also often expected to include research, writing and light front-end knowledge without any extra recognition for it.",
      misconception:
    ...
    },
    {
      ...
      values: ["creating", "stability"],
      dayToDay:
        "Drawings, models and coordination. Early project stages are genuinely creative; the longer middle is technical documentation, building regulations, and resolving how the design meets structure, services and budget. Site visits mean checking that what is being built matches what was drawn, and deciding what to do when it doesn't.",
      catch:
    ...
    },
    {
      ...
      notForYou:
        "You want creative freedom without cost pressure, or steady employment. Prototypes and production runs make being wrong expensive, much of this area is freelance, so finding clients and chasing payment are permanent parts of it Manufacturing also sits in specific regions rather than wherever you live.",
      misconception:
        "That the work is designing beautiful objects. It's designing objects that can be made repeatedly at a price, which is a manufacturing problem as much as an aesthetic one, and the constraint is usually where the interesting design decisions live.",
      stages: {
        school:
        ...
        study:
          "Industrial design, fashion, fine art or craft. Look for programmes with real workshops and industry projects; the technical half of this field can't be learned from a screen.",
        first:
      ...
      tryItNow:
        "Design and actually make one object you'll use daily, then work out honestly what it would cost to make fifty of them. That second number is the part most people never think about.",
