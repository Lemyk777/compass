...
const ru: Dict = {
  ...
  "auth.asideBadge": "Создано для абитуриентов со всего мира",
  ...
  "auth.asideStat3": "США · Италия · Гонконг",
  ...
  "dest.soon": "Скоро",
  // Attribution survey ("how did you hear about us?")
  "ob.tSource": "Откуда вы узнали о нас?",
  "ob.sSource": "Один короткий вопрос — это помогает нам находить таких студентов, как вы.",
  "ob.errSource": "Выберите один вариант.",
  "src.social": "Соцсети",
  "src.friend": "Рассказали друзья",
  "src.search": "Поиск (Google)",
  "src.school": "Школа / консультант",
  "src.ambassador": "Амбассадор",
  "src.other": "Другое",
  "ob.sourceCodeLabel": "Код амбассадора (необязательно)",
  "ob.sourceCodePh": "напр. ALMATY25",
  "ob.sourceCodeHint": "Если вам дали код — введите его, чтобы зачесть амбассадору.",
  ...
  "nav.standing": "Ваш результат",
  "nav.results": "Шансы поступления",
  "nav.costs": "Стоимость заявок",
  "nav.plan": "План действий",
  "nav.timeline": "Сроки",
  "nav.summary": "Итог",
