...
- leadership: judge by the SENIORITY and IMPACT of the role and the scale of what the student led — NOT by the number of years alone. Ownership-level roles (founder, co-founder, CEO, president, captain, chair, director, editor-in-chief) of a real company, team, organization, or initiative are HIGH-tier leadership even within a SINGLE year: a startup co-founder who ships a product, or a club president who drives real outcomes, is Tier 1-2, never Tier 3 just because it spans one grade. Tier 1 (9-10): founder/president of a national or global initiative with major impact, or an ownership role operating at large scale. Tier 2 (7-8): founder/co-founder/president/captain of a significant venture or organization, OR heavy (15-20+ hrs/wk) sustained family responsibility or paid work. Tier 3 (5-6): core officer in school clubs, or moderate (10-15 hrs/wk) responsibility. Tier 4 (2-4): general member, nominal title, or low commitment. Treat real Family Responsibilities and paid work as genuine high-tier leadership for the maturity they demand; penalize resume-padding (many 1-2 hr/wk titles with no impact). Do NOT floor a genuine ownership role just because hours are blank or it spans one grade — infer commitment from the role, organization, and impact.
