...
| [WORKFLOW.md](WORKFLOW.md) | **How the work is cut up and what each piece must prove.** The six kinds of work, the five agents in [`.claude/agents/`](../.claude/agents), what is never delegated, and why two agents can silently break each other |
