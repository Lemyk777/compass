...
| [WORKFLOW.md](WORKFLOW.md) | **What to do yourself, what to split off, and what it costs.** The default is inline; an agent has to beat a ~30k-token cold start before it is worth dispatching. The two rules, the three-question test, the six kinds of work, session economics, and why two agents can silently break each other |
