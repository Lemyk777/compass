...
1. **Opportunities** — the front door, and the thing a student arrives for. A
   ...
   programmes, communities and job simulations — **172 entries as of
   2026-08-17** — matched to their field, country, school year and age, with
...
| `npm run test:unit` | **282 unit tests** over the deterministic core (node:test — no key, no network, no database) |
