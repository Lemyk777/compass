...
const PAINS: { n: string; title: React.ReactNode; body: string }[] = [
  ...
  },
  {
    ...
    title: (
      <>
        &ldquo;Free&rdquo; that isn&rsquo;t
      </>
    ),
...
export default async function LandingPage() {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-surface text-ink selection:bg-ink selection:text-white">
      ...
      <section className="w-full border-y border-black/5 bg-ink px-6 py-24 text-white md:px-12 md:py-28 lg:px-20">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-4 max-w-2xl text-pretty text-lg font-light leading-relaxed text-white/60">
            ...
            hundreds of results. Almost none of them tell you the one thing that
            decides everything: whether someone your age, in your country, can
            enter at all.
          </p>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 text-balance text-3xl font-medium tracking-tight text-ink md:text-4xl">
              &ldquo;And then what?&rdquo; — answered before you enter, not after.
            </h2>
            <p className="mt-4 max-w-xl text-pretty text-lg font-light leading-relaxed text-ink/60">
              The guide runs the whole chain: what you like → the areas of work
              it opens → the countries and cities that work lives in → and what
              you can enter from home without moving anywhere. Every one of them
              states its catch, not just its brochure.
            </p>
          </div>
      ...
      <section className="w-full border-y border-line bg-card">
        <div className="mx-auto max-w-6xl px-6 py-24 md:px-12 md:py-28 lg:px-20">
          ...
          <p className="mt-6 max-w-3xl text-pretty text-lg font-light leading-relaxed text-ink/60 md:text-xl">
            ...
            reach than let you find out yourself in three months. Unknown facts
            never remove an opportunity from your list; unverified dates never
            get a countdown; and nothing is called free unless it is.
          </p>
        </div>
      </section>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,420px)]">
            <div>
              ...
              <p className="mt-4 max-w-xl text-pretty text-lg font-light leading-relaxed text-ink/60">
                ...
                profile and you get a competitiveness score out of 100, per-school
                admission ranges, your grades and tests against each school&rsquo;s
                admitted middle 50%, and a prioritised list of what to fix — across{" "}
                the US, Italy, Hong Kong, the UAE and Korea.
              </p>
          ...
          <div className="mt-16 grid items-center gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,520px)]">
            <div className="order-2 lg:order-1">
              ...
              <p className="mt-3 max-w-md text-pretty text-base font-light leading-relaxed text-ink/60">
                ...
                range is tied to a specific school&rsquo;s published admitted-student
                data, in every country the report covers.
              </p>
            </div>
