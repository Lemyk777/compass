    ...
    <main className="min-h-dvh bg-surface text-ink">
      ...
      <div className="mx-auto max-w-2xl px-5 py-14 sm:px-6">
        ...
        <p className="mt-4 text-pretty text-base leading-relaxed text-ink-soft">
          ...
          actually fit — not everyone, and not nobody. There is nothing to pay,
          and you can take anything down yourself.
        </p>
        ...
        <ul className="mt-6 space-y-2 text-[0.95rem] leading-relaxed text-ink-soft">
          ...
          <Point>
            Once we&rsquo;ve confirmed the account belongs to your organisation,
            everything you post carries a verification mark.
          </Point>
          <Point>
            You get a public page listing everything you have open — a link you
            can send to your own audience.
          </Point>
        </ul>
          ...
          {session ? (
            ...
            <div className="rounded-2xl border border-line bg-card p-6 shadow-card">
              <p className="text-base font-semibold text-ink">
                Sign in first — the account you use becomes the account you post
                from.
              </p>
